<div x-data="{ open: false }" @click.away="open = false" class="relative">
    <button 
        @click="open = !open" 
        type="button"
        class="flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition-colors hover:bg-gray-100 dark:hover:bg-gray-800 group"
    ...
    >
        <div class="relative">
            ...
            <span class="absolute -bottom-1 -right-1 text-[10px] font-bold bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 group-hover:text-emerald-600 rounded-full px-1 py-0.5 border border-gray-200 dark:border-gray-600 shadow-sm leading-none transition-colors duration-200">
