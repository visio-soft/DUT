        ...
        <div>
            <style>
                ...
                .palette-list-item {
                    ...
                    padding: 8px 6px;
                    border-radius: 8px;
                    border-bottom: 1px solid color-mix(in srgb, var(--fd-border) 75%, transparent);
                    transition: all .15s ease;
                }

                .palette-list-item:hover {
                    background: color-mix(in srgb, var(--fd-accent) 6%, var(--fd-panel-bg));
                ...
                .palette-thumb {
                    ...
                    border: 1px solid color-mix(in srgb, var(--fd-border) 60%, transparent);
                }
                ...
                .description-empty {
                    ...
                    text-align: center;
                    padding: 20px;
                    background: color-mix(in srgb, var(--fd-border) 20%, transparent);
                    border-radius: 8px;
                    border: 1px dashed var(--fd-border);
                }
                    ...
                    <div class="element-palette">
                        ...
                        @if (empty($elements))
                            <div class="empty-state">
                                ...
                                <div style="font-size:13px; color:color-mix(in srgb, var(--fd-text) 60%, transparent);">
                                    Tasarım kaydı boş veya yüklenemedi.</div>
                            </div>
                        @else
                        ...
                        <div class="property-boundary" id="propertyBoundary">
                            ...
                            @if(!empty($elements))
                                @foreach($elements as $el)
                                    ...
                                    <div class="landscape-element" title="{{ $name }}"
                                        style="transform: translate({{ (int) $x }}px, {{ (int) $y }}px) rotate({{ (float) $rotation }}deg); width: {{ (int) $w }}px; height: {{ (int) $h }}px;">
            ...
            <div class="description-section">
                <div class="description-box">
                    ...
                    @if(!empty($project) && !empty($project->description))
                        <div class="description-content">{{ $project->description }}</div>
                    @else
                        <div class="description-empty">Bu öneri için açıklama bulunmamaktadır.</div>
                    @endif
                </div>
            </div>
