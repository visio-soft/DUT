...
<section class="user-hero dynamic-background {{ ($hasBackgroundImages ?? false) ? '' : 'no-background-images' }}">
    ...
    <div class="user-container">
        <div class="user-hero-content">
            <h1>{{ __('user.hero_title_part1') }} <span style="color: var(--green-700);">{{ __('user.hero_title_part2') }}</span></h1>
            <p>
                {{ __('user.hero_description') }}
            </p>
...
<section id="projects" class="section-padding-lg">
    <div class="user-container">
        <div class="text-center content-spacing-xl">
            <h2 style="font-size: 2.5rem; margin-bottom: 1rem;">{{ __('user.featured_projects') }}</h2>
            <p style="font-size: 1.125rem; color: var(--gray-600); max-width: 600px; margin: 0 auto;">
                {{ __('user.featured_projects_desc') }}
            </p>
        </div>
                            ...
                            @if($project->getFirstMediaUrl('project_files'))
                                <div class="project-background-with-blur">
                                    ...
                                    <img src="{{ $project->getFirstMediaUrl('project_files') }}"
                                         ...
                                         onerror="this.onerror=null; this.parentElement.innerHTML='<div class=&quot;project-placeholder&quot;><div style=&quot;text-align: center;&quot;><svg style=&quot;width: 3rem; height: 3rem; color: var(--green-600); margin-bottom: 0.5rem;&quot; fill=&quot;currentColor&quot; viewBox=&quot;0 0 20 20&quot;><path fill-rule=&quot;evenodd&quot; d=&quot;M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z&quot; clip-rule=&quot;evenodd&quot;/></svg><p style=&quot;color: var(--green-700); font-size: 0.875rem;&quot;>Proje Görseli</p></div></div>';">
                                </div>
                            @else
                                <div class="project-placeholder">
                                    <div style="text-align: center;">
                                        ...
                                        <p style="color: var(--green-700); font-size: 0.875rem;">{{ __('user.project_image') }}</p>
                                    </div>
                                </div>
                            @endif
                        </div>
                                ...
                                @if($project->end_datetime)
                                    ...
                                    <div class="project-stat" style="color: {{ $isExpired ? 'var(--red-600)' : 'var(--green-600)' }}; font-weight: 600;">
                                        ...
                                        @elseif($remainingTime)
                                            {{ $remainingTime['formatted'] }} {{ __('user.remaining') }}
                                        @else
                                            {{ __('user.unlimited') }}
                                        @endif
                                    </div>
        ...
        @else
            <div class="text-center section-padding">
                <div class="user-card" style="max-width: 400px; margin: 0 auto; padding: 3rem;">
                    ...
                    <h3 style="font-size: 1.25rem; font-weight: 600; color: var(--gray-900); margin-bottom: 0.5rem;">{{ __('user.no_projects') }}</h3>
                    <p style="color: var(--gray-500);">{{ __('user.waiting_for_projects') }}</p>
                </div>
            </div>
        @endif
