...
@section('title', __('messages.home') . ' - DUT Vote')
...
<section class="user-hero dynamic-background {{ ($hasBackgroundImages ?? false) ? '' : 'no-background-images' }}">
        ...
        @if($randomBackgroundImage)
            ...
            <div class="background-image-container">
                <img src="{{ $randomBackgroundImage }}"
                     alt="{{ __('messages.hero_title') }} {{ __('messages.hero_title_transform') }}"
    ...
    <div class="user-container">
        <div class="user-hero-content">
            <h1>{{ __('messages.hero_title') }} <span style="color: var(--green-700);">{{ __('messages.hero_title_transform') }}</span></h1>
            <p>
...
<section id="projects" class="section-padding-lg">
    <div class="user-container">
        <div class="text-center content-spacing-xl">
            <h2 style="font-size: 2.5rem; margin-bottom: 1rem;">{{ __('messages.featured_projects') }}</h2>
            <p style="font-size: 1.125rem; color: var(--gray-600); max-width: 600px; margin: 0 auto;">
                {{ __('messages.featured_projects_description') }}
            </p>
        </div>
                            ...
                            @else
                                <div class="project-placeholder">
                                    <div style="text-align: center;">
                                        ...
                                        <p style="color: var(--green-700); font-size: 0.875rem;">{{ __('messages.project_image') }}</p>
                                    </div>
                                </div>
                            @endif
                        </div>
