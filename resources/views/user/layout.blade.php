                    ...
                    @auth
                        <div class="flex items-center space-x-3">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm" style="color: #053640;">{{ __('user.hello') }}, {{ Auth::user()->name }}</span>
                            </div>
                        ...
                        @auth
                            <div class="mobile-auth-section">
                                <div class="mobile-user-info">
                                    ...
                                    <span class="text-sm text-white/90">{{ __('user.hello') }}, {{ Auth::user()->name }}</span>
                                </div>
            ...
            <div class="user-footer-content">
                ...
                <div class="footer-bottom">
                    <div class="footer-credits">
                        <p>© 2025 DUT Vote. {{ __('user.all_rights_reserved') }}</p>
                        <p class="developed-by">
                            <svg class="icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z"/>
                            </svg>
                            {{ __('user.developed_by') }} <a href="https://visiosoft.com.tr" target="_blank">VisioSoft</a>
                        </p>
                    </div>
                </div>
            </div>
