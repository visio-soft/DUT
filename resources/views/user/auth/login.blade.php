...
@section('title', __('common.login') . ' - DUT Vote')
...
<div class="min-h-[calc(100vh-theme('spacing.16'))] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <form method="POST" action="{{ route('user.login') }}" class="mt-8 space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox"
                        class="h-5 w-5 text-green-600 focus:ring-green-500 border-gray-300 rounded cursor-pointer transition ease-in-out duration-150">
