...
@section('title', __('messages.register_title') . ' - DUT Vote')
                ...
                <form method="POST" action="{{ route('user.register') }}" style="space-y: 1.5rem;">
                    ...
                    <div style="padding: 1rem; background: var(--green-50); border: 1px solid var(--green-200); border-radius: var(--radius-md);">
                        <label style="display: flex; align-items: flex-start; gap: 0.75rem; font-size: 0.875rem; color: var(--gray-600); cursor: pointer;">
                            ...
                            >
                            <span>
                                {{ __('messages.accept_terms') }} <a href="#" style="color: var(--green-600); text-decoration: underline;">{{ __('messages.terms_of_service') }}</a> {{ __('messages.and') }} <a href="#" style="color: var(--green-600); text-decoration: underline;">{{ __('messages.privacy_policy') }}</a>{{ __('messages.accept_terms_suffix') }}
                            </span>
                        </label>
                    </div>
