                ...
                <div class="content-spacing-lg">
                    <div style="flex: 1;">
                        ...
                        <div class="detail-meta">
                            ...
                            @if($suggestion->budget && !$suggestion->hide_budget && !$suggestion->category->hide_budget)
                            <div style="display: flex; align-items: center;">
                                ...
                                <span style="font-weight: 600; color: var(--green-700);">
                                    @if($suggestion->min_budget && $suggestion->max_budget)
                                        ₺{{ number_format($suggestion->min_budget, 0) }} - ₺{{ number_format($suggestion->max_budget, 0) }} 
                                    @elseif($suggestion->min_budget)
                                        ₺{{ number_format($suggestion->min_budget, 0) }}+
                                    @elseif($suggestion->max_budget)
                                        ₺{{ number_format($suggestion->max_budget, 0) }}
                                    @endif
                                </span>
                            </div>
                            @endif
